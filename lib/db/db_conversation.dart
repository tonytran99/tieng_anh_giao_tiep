...
class DBStory {
  ...
  _onCreate(Database db, int version) async {
    await db.execute("CREATE TABLE $TABLE ( $ID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, $UID TEXT, $NAME_EN TEXT, $NAME_VI TEXT, $DESCRIPTION_EN TEXT, $DESCRIPTION_VI TEXT, $PHOTO TEXT, $NORMAL_AUDIO TEXT, $SPEED_AUDIO TEXT, $HAS_AUDIO_SENTENCES TEXT, $LIST_PERSON TEXT,$CREATED_AT TEXT, $UPDATED_AT TEXT, $TOPIC_ID TEXT)");
  }
